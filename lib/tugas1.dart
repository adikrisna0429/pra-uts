...
class Tugas1 extends StatelessWidget {
  ...
  final List<LaptopProduct> phoneProducts = [
    LaptopProduct(
...
ListTile(
  title: Text('Bantuan'),
  onTap: () {
    // Aksi ketika menu Bantuan diklik
  },
),
            ],
          ),
        ...
        body: TabBarView(
          children: [
            ListView.builder(
              ...
              itemCount: (laptopProducts.length / 2).ceil(),
                ...
                return Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: buildProductCard(laptopProducts[index * 2]),
                        ),
                        SizedBox(width: 16),
                        Expanded(
                          child: laptopProducts.length > index * 2 + 1
                              ? buildProductCard(laptopProducts[index * 2 + 1])
                              : Container(),
                        ),
                      ],
                    ),
...
Widget buildProductCard(LaptopProduct product) {
    return Builder(
